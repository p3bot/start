...
// modules_install and modules_update. Each command's post-fetch logic stays
// at its call site because the commands use the index differently and
// consolidating further would obscure call-site UX.
//
